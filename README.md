...
必要なものは Node.js 20.19 以上（または22以上）です。Viteの動作要件に合わせています。
...
- `src/lib/__tests__/` … 経過秒数や90秒判定、報告文、localStorage保存の単体テスト
- `src/__tests__/app.test.jsx` … 番号タップ→証明書発行→精算→報告までの画面操作テスト
